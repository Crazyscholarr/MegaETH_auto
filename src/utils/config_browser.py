...
# Thêm trình xử lý lỗi cho Flask
@app.errorhandler(Exception)
def handle_exception(e):
    """Xử lý ngoại lệ không được xử lý"""
...
def open_browser():
    ...
    # Mở trình duyệt sau khi khởi động máy chủ
...
def create_required_directories():
    ...
    # Tạo các thư mục cần thiết cho mẫu và tệp tĩnh
    try:
...
def check_paths():
    ...
    # Kiểm tra đường dẫn đến tệp và thư mục
    try:
...
def run():
    ...
    # Khởi chạy giao diện web để chỉnh sửa cấu hình
    try:
