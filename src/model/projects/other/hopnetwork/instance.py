...
class HopNetwork:
    ...
    async def waitlist(self):
        try:
            ...
            logger.success(
                f"{self.account_index} | Tham gia thành công danh sách chờ trên HopNetwork! "
            )
            return True
            ...
            logger.error(
                f"{self.account_index} |Lỗi tham gia danh sách chờ trên HopNetwork: {e}. Đang chờ {random_pause} seconds..."
            )
